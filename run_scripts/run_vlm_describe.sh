...
#     --data_name cifar100 \
#     --output_path /home/maitanha/cll_vlm/cll_vlm/ol_cll_logs/describe/cifar100_clip_top3_llava_prompt1.csv \
#     --model_type llava \
#     --batch_size 64 \
#     --prompt "Identify the main object in this image."
...
# CUDA_VISIBLE_DEVICES=0 python ${PYTHON_FILE} \
#     --data_name cifar100 \
#     --output_path /home/maitanha/cll_vlm/cll_vlm/ol_cll_logs/describe/cifar100_clip_top3_llava_prompt2.csv \
#     --model_type llava \
#     --batch_size 64 \
#     --prompt "What is the main object in this image? Answer with a short noun phrase."

# CUDA_VISIBLE_DEVICES=0 python ${PYTHON_FILE} \
#     --data_name cifar100 \
#     --output_path /home/maitanha/cll_vlm/cll_vlm/ol_cll_logs/describe/cifar100_clip_top3_llava_prompt3.csv \
#     --model_type llava \
#     --batch_size 64 \
#     --prompt "Can you name the specific item pictured here?"